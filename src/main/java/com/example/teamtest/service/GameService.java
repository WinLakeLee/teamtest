...
public class GameService {
	...
	public Map<String, List<HonorListDTO>> getScore() {
	    ...
	    List<HonorListDTO> lolTop5 = rankRepository.findAllByOrderByLolScoreDesc()
	            .stream()
	            .limit(5)
	    ...
	    List<HonorListDTO> bgTop5 = rankRepository.findAllByOrderByBgScoreDesc()
	            .stream()
	            .limit(5)
	    ...
	    List<HonorListDTO> scTop5 = rankRepository.findAllByOrderByScScoreDesc()
	            .stream()
	            .limit(5)
	    ...
	    List<HonorListDTO> msTop5 = rankRepository.findAllByOrderByMsScoreDesc()
	            .stream()
	            .limit(5)
